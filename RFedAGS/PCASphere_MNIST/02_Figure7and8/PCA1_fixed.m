...
rho1 = 0.3;
s = 60 * rho1;
[fvs1, times1, numgfs1] = PCA1_testing_fixed(x0, K, option, s, Seed, stepsize, pi);

rho2 = 0.5;
s = 60 * rho2;
[fvs2, times2, numgfs2] = PCA1_testing_fixed(x0, K, option, s, Seed, stepsize, pi);

rho3 = 0.7;
s = 60 * rho3;
[fvs3, times3, numgfs3] = PCA1_testing_fixed(x0, K, option, s, Seed, stepsize, pi);
...
pi = [0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3,...
      ...
      0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3,...
      0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3];
[fvs5, times5, numgfs5] = PCA1_testing_fixed(x0, K, option, s, Seed, stepsize, pi);
...
pi = [0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5,...
      ...
      0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5,...
      0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5];
[fvs6, times6, numgfs6] = PCA1_testing_fixed(x0, K, option, s, Seed, stepsize, pi);
...
pi = [0.7, 0.7, 0.7, 0.7, 0.7, 0.7, 0.7, 0.7, 0.7, 0.7,...
      ...
      0.7, 0.7, 0.7, 0.7, 0.7, 0.7, 0.7, 0.7, 0.7, 0.7,...
      0.7, 0.7, 0.7, 0.7, 0.7, 0.7, 0.7, 0.7, 0.7, 0.7];
[fvs7, times7, numgfs7, problem] = PCA1_testing_fixed(x0, K, option, s, Seed, stepsize, pi);
